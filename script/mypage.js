...
import { followApi, checkAnonymous } from "./api.js";
...
window.onload = async function loadProfile() {
  ...
  document.getElementById(
    "userName"
  ).innerText = `별명 : ${responseJson["유저"]["username"]}`;
  document.getElementById(
    "userDay"
  ).innerText = `총 학습 일수 : ${responseJson["정보"]["total_study_day"]}일`;
  document.getElementById(
    "userLevel"
...
document
  ...
  .addEventListener("click", handleEditPage);
